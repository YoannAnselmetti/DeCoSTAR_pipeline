...
###         (/share/nas-isem_i/yanselmetti/BIRDS_PROJECT/DATA_SEQ/SCAFFOLDING/BESST-2.2.6/Bowtie2_k100/TRIM/Acanthisitta_chloris)
###      3- TAG to allow severa experiments without interfering with jobs of others experiments
###         (Achl_Bowtie2_k100_TRIM)
###      3- Orientation file
...
script_BESST_stats="/share/nas-isem_i/yanselmetti/BIRDS_PROJECT/script/pipeline_input-decostar/DATA_SEQ_DECOSTAR/BESST_stats.py"
file_orientation="/share/nas-isem_i/yanselmetti/BIRDS_PROJECT/DATA_SEQ/orientation_libraries"
